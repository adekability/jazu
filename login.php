...
<head>
<title>Login</title>
<link rel="stylesheet" type="text/css" href="snike.css">
...
<tr>
	...
	<tr>
	<?php	//<td>Username:</td> ?>
		<td><input id="user" type="text" name="username" class="textInput" placeholder="username"required"></td>

	</tr>
	<tr>
		<?php	//<td>Password:</td>?>
		<td><input  id="pass" type="password" name="password" class="textInput" placeholder="password"required></td>
...
<input name ="x" type="submit" class="button x" value="x" onclick="keyboardPressed(this.value)">
 ...
 <!--<input type="submit" class="button m" value="m">-->
  <input name ="m" type="submit" class="button m" value="m" onclick="keyboardPressed(this.value)"> 
 <!--<button name="m" class="button m" onclick="keyboardPressed(this.value)">m</button>-->
 	</body>
</html>